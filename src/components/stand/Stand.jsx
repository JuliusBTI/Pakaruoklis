...
const BODY = (
    <div style={{ width: "10px", height: "100px", position: "absolute", background: "black", top: "120px", right: 0 }} />
)
...
const LEFT_LEG = (
    <div style={{ width: "100px", height: "10px", position: "absolute", background: "black", top: "210px", right: 0, rotate: "-60deg", transformOrigin: "right bottom" }} />
)
...
export function Stand({ numberOfGuesses }: StandProps) {
    return (
